...
<head>
    ...
    <title>Altes Römisches Reich</title>
...
<body>
    ...
    <div class="Bilder1">
        <img class="Bilder" src="bilder/Roemisches_Reich.jpg">
    </div>

    <div class="box">
        <h1 class="InfoÜberschrift">Altes Römisches Reich</h1>
        <p class="Infotext">
            Erleben Sie die Pracht und den Glanz des alten Römischen Reiches. Tauchen Sie ein in die Geschichte und erkunden Sie die antiken Ruinen, beeindruckende Amphitheater und majestätische Tempel. Genießen Sie die kulinarischen Köstlichkeiten der römischen Küche und lassen Sie sich von der Schönheit der römischen Kunst und Architektur verzaubern.
        </p>
    </div>

    <div class="Bestellen">
        <?php foreach ($roemisches_reich_feld as $key => $value) : ?>
