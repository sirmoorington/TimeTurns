...
<head>
    ...
    <title>Goldene Ära des Islam</title>
...
<body>
    ...
    <div class="Bilder1">
        <img class="Bilder" src="bilder/Islamische_Goldene_Aera.jpg">
    </div>

    <div class="box">
        <h1 class="InfoÜberschrift">Goldene Ära des Islam</h1>
        <p class="Infotext">
            Erleben Sie die goldene Ära des Islam, eine Zeit des Wissens, der Innovation und des kulturellen Austauschs. Entdecken Sie die faszinierende Welt der islamischen Wissenschaften, Kunst und Philosophie. Tauchen Sie ein in die prächtigen Moscheen, die poetische Literatur und die beeindruckende Architektur dieser Epoche. Lassen Sie sich von der Schönheit und dem Reichtum der islamischen Kultur inspirieren.
        </p>
    </div>

    <div class="Bestellen">
        <?php foreach ($goldene_aera_islam_feld as $key => $value) : ?>
