...
<body>
    ...
    <div class="Bilder1">
        <img class="Bilder" src="bilder/Aztekenreich.jpg">
    </div>

    <div class="box">
        <h1 class="InfoÜberschrift">Das Aztekenreich</h1>
        <p class="Infotext">
            Erleben Sie die faszinierende Kultur und Geschichte des Aztekenreiches. Entdecken Sie die prächtigen Tempel, die kunstvollen Skulpturen und die lebendigen Traditionen dieser alten Zivilisation. Tauchen Sie ein in die mystische Welt der Azteken, erfahren Sie mehr über ihre religiösen Rituale und ihre beeindruckende Architektur. Lassen Sie sich von der Schönheit und dem Erbe des Aztekenreiches verzaubern.
        </p>
    </div>

    <div class="Bestellen">
        <?php foreach ($aztekenreich_feld as $key => $value) : ?>
